...
- Co-ownership briefings: project-level and module-level machine orientation
  (see [[file:co-ownership-briefing.org][co-ownership briefing report]] for principles and templates)
