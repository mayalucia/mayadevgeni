#+title: Crafting Your System-Prompt
...
** Economy
The context window is finite. Your system-prompt competes with conversation history for the model's attention. Every unnecessary token dilutes the signal. Be concise—not terse, but /dense/. Say what matters; omit what doesn't.
...
** Form as Content
The LLM is an imitation engine. It will echo the patterns it observes. If your system-prompt is structured and precise, responses tend toward structure and precision. If your prompt rambles, responses may ramble. /Demonstrate/ the behavior you want; don't just describe it.
...
* Building a System-Prompt: A Worked Example
...
Now we've shaped /how/ it engages—reflective, honest about limits, epistemically careful.
...
#+begin_quote
/Next: [[file:05-failures.org][When Prompts Fail: A Diagnostic Guide]]/
#+end_quote
